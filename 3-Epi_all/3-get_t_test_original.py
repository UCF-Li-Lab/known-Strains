...
def get_snp_fre():
    ...
    f1 = open('/media/saidi/Elements/Project/Project17_1_MSMS/testing_real/Min_data/chang_paper/Epidermidis/NZ_CP035288.1/result_new_version_cutoff_score3_3_4.5/n1_nodes_vector_original.bed','r')
    lines1 = f1.readlines()
...
input_path = '/media/saidi/Elements/Project/Project_for_Min/KSPaper_by_me1/known_strain_unique_SNP/Epi'
output_path = '/media/saidi/Elements/Project/Project_for_Min/KSPaper_by_me1/t-test_original/Epi'
