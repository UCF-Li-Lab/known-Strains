...
output_path = '/media/saidi/Elements/Project/Project_for_Min/KSPaper_by_me1/ks_test/Epi'

files = [i for i in os.listdir(input_path) if 'SNPs_statistics.bed' not in i]

f3 = open(output_path + '/' + 'Epi_original.txt', 'w')
f4 = open(output_path + '/' + 'Epi_non_repeat.txt', 'w')
for file in files:
