...
input_path = '/media/saidi/Elements/Project/Project_for_Min/KSPaper_by_me1/t-test_original_sorted/Epi'
...
df.to_csv('/media/saidi/Elements/Project/Project_for_Min/KSPaper_by_me1/t-test_original_sorted/Epi_stat',sep = '\t')
